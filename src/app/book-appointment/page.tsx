          ...
          >
              ...
              {[
                {
                  step: "1",
                  title: "Fill the Form",
                  desc: "Select your treatment, date, and preferred time.",
                },
                {
                  step: "2",
                  title: "We Confirm",
                  desc: "Our team will call or message you within a few hours.",
                },
                {
                  step: "3",
                  title: "Arrive & Relax",
                  desc: "Come to Hridaya Spa and enjoy your session.",
                },
              ].map((item) => (
                <div
                  key={item.step}
            ...
            <a
              ...
              style={{
                ...
                boxShadow: "0 4px 20px rgba(184,148,31,0.3)",
              }}
            >
              <p
                style={{
